...
export default function IntegrationTypes() {
  ...
  >
    <div class="split-section wf-section">
      ...
      <div class="split-section-content-half">
        <div class="title-wrapper">
          <h3>Tipos de Integração</h3> 
        </div>
        
        <div class="flex-horizontal">
          <div class="card-bundle margin-top" style={{
            willChange: "transform", 
            transform: "translate3d(0px, 0%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)", 
            transformStyle: "preserve-3d"
          }}>
          <div class="card-bundle-image-wrapper">
        ...
        <div class="card-bundle margin-top" style={{
          ...
          <div class="card-bundle-image-wrapper">
          <img src="https://assets.website-files.com/60d0b9d684d42a0424dfb8c5/60e873b67fe3f27da31b60a9_Instagram%2B-Template.jpg" loading="lazy" width="400" alt="A girsl, sitting on the floor, working on the computer, on a coffee table." class="image-cover"/>
          </div>
        <div class="card-bundle-content-wrapper">
        ...
        <div class="card-bundle" style={{
          ...
          <div class="card-bundle-image-wrapper">
          <img src="https://assets.website-files.com/60d0b9d684d42a0424dfb8c5/60e737fa215be018dcbfe1b0_Moodboard-Template.jpg" loading="lazy" width="400" alt="A teared photo and pantone colors on a beige surface with a dry flower. " class="image-cover"/>
          </div>
        <div class="card-bundle-content-wrapper">
      ...
      <div class="split-section-image-half">
        <div >
